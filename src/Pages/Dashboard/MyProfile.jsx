...
const MyProfile = () => {
  ...
  return (
    <div className="md:max-w-xl mx-auto bg-base-100 border border-primary rounded-lg p-8 shadow-lg">
      ...
      <div className="text-center font-bold text-4xl text-primaryBg mb-6">
        <h2 className="font-cinzel">My Profile</h2>
      </div>
      <div className="flex flex-col items-center justify-center space-y-10">
        <div className="text-center">
          <h2 className="font-semibold text-2xl text-primaryBg mb-4">
            Profile Photo
          </h2>
          <img
        ...
        <div className="w-full text-center space-y-6">
          <div>
            <h2 className="font-semibold text-2xl text-primaryBg mb-2">Name</h2>
            <p className="text-lg text-gray-700">
              {user?.displayName || "Not Provided"}
            </p>
          </div>
          <div>
            <h2 className="font-semibold text-2xl text-primaryBg mb-2">Email</h2>
            <p className="text-lg text-gray-700">
          ...
          {isAdminOrMod === "Admin" || isAdminOrMod === "Moderator" ? (
            <div>
              <h2 className="font-semibold text-2xl text-primaryBg mb-2">Role</h2>
