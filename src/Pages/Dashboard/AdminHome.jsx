...
const AdminHome = () => {
  ...
  return (
    <div>
      ...
      <div>
        <div className="flex flex-col md:flex-row justify-between mt-5 text-xl font-bold text-[#247CFF]">
      ...
      <div className="my-10">
        <h2 className="text-center underline font-cinzel text-3xl text-[#247CFF] font-bold">
